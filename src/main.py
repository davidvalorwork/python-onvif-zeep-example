...
from utils.scale import scale_angle_0to1, scale_angle_90degresstilt, scale_angle_less1to1
...
def main(json_parameters):
    ...
    # Adjust pan_transformada based on rotation direction and scale
    if(scale_pan == '01'): pan = scale_angle_0to1(pan)
    if(scale_pan == '-11'): pan = scale_angle_less1to1(pan)
